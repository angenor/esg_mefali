...
FINANCING_TOOLS = [
    with_retry(search_compatible_funds, max_retries=2, node_name="financing"),
    with_retry(save_fund_interest, max_retries=2, node_name="financing"),
    with_retry(get_fund_details, max_retries=2, node_name="financing"),
    with_retry(create_fund_application, max_retries=2, node_name="financing"),
]
